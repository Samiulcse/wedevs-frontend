<template>
    <nav aria-label="Page navigation" v-if="paginateData.total > 0">
        <ul class="pagination justify-content-center pagination-lg">
            <li class="page-item" :class="{' disabled': paginateData.current_page == 1}">
                ...
                <a class="page-link" href="javascript:void(0)" v-else @click="changePage(1)">
                    Previous
                </a>
            </li>
            <li class="page-item " :class="{' disabled': paginateData.current_page == 1}">
            ...
            <li class="disabled" v-if="paginateData.current_page > 2 && paginateData.current_page <= paginateData.last_page">...</li>
            ...
            <li class="page-item disabled" v-if="paginateData.current_page <= paginateData.last_page-2"><a class="page-link" href="#" tabindex="-1" aria-disabled="true">...</a></li>
            ...
            <li class="page-item" :class="{' disabled': paginateData.current_page == paginateData.last_page}">
                ...
                <a href="javascript:void(0)" v-else @click="changePage(paginateData.last_page)">
                    Next
                </a>
...
export default {
    ...
    methods: {
        changePage(page) {
            var queryParameter = this.paginateData.query_parameter
            const currentQuery = this.$parent.$router.currentRoute.query
            let mergedQuery = { ...currentQuery,  page}
            mergedQuery = { ...mergedQuery,  ...queryParameter}
            this.$parent.$router.push({query: mergedQuery })
            this.$emit('paginate')
        }
    }
}
